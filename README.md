...
### QCOM RB5 build
The following appends were created to fix RB5 QRB5165.LU2.0_20250723.2230_debug build:
- recipes-toolchain/ubuntu/python3-ubuntu_%.bbappend: replaces broken SRC_URIs with valid.
- recipes-core/expat/expat_%.bbappend: disables expat documentation to avoid **error: Your local docbook2man was found to work with SGML rather than XML**.
